...
import com.cleversafe.leveldb.impl.ReverseIterators;
...
public class DBIteratorTest
{
            ...
            throws Exception
    {
        ...
        env = new StrictEnv();
        db = Iq80DBFactory.factory.open(tempDir, options.env(env).memoryManager(env.strictMemory));
    }
