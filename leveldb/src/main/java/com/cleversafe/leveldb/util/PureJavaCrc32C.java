        ...
        implements ByteBufferCrc32C
{
    ...
    public void update(ByteBuffer b, int off, int len)
    {
        ...
        else
        {
            ...
            while (len > 0)
            {
                ...
                ByteBuffers.duplicateByLength(b, off, l).get(buf, 0, l);
                update(buf, 0, l);
                len -= l;
                off += l;
            }
   ...
   */
    static final int T8_0_start = 0 * 256;
    static final int T8_1_start = 1 * 256;
    static final int T8_2_start = 2 * 256;
    static final int T8_3_start = 3 * 256;
    static final int T8_4_start = 4 * 256;
    static final int T8_5_start = 5 * 256;
    static final int T8_6_start = 6 * 256;
    static final int T8_7_start = 7 * 256;
