...
abstract class FastByteComparisons
{
    ...
    /**
     * Provides a lexicographical comparer implementation; either a Java implementation or a faster implementation based on {@link Unsafe}.
     *
     * <p>
    ...
    private static class LexicographicalComparerHolder
    {
                ...
                implements Comparer<byte[]>
        {
            ...
            public int compareTo(byte[] buffer1, int offset1, int length1, byte[] buffer2, int offset2, int length2)
            {
                ...
                /*
                 * Compare 8 bytes at a time. Benchmarking shows comparing 8 bytes at a time is no slower than comparing 4 bytes at a time even on 32-bit. On the other hand, it is substantially faster
                 * on 64-bit.
                 */
