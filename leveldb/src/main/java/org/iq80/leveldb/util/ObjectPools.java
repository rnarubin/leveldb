...
public abstract class ObjectPools
{
    ...
    private static class FixedAllocatingPool<T>
            extends FixedBitSetPool<T>
    {
    ...
    private static class FixedBlockingPool<T>
            extends FixedBitSetPool<T>
    {
    ...
    private static class DirectBufferPool
            extends FixedAllocatingPool<ByteBuffer>
    {
    ...
    private abstract static class FixedBitSetPool<T>
            implements ObjectPool<T>
    {
        ...
        protected class IndexedPooledObject
    ...
    private static class SimplePooledObject<T>
            implements PooledObject<T>
    {
        private final T object;
