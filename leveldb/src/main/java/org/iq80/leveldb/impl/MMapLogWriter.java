        ...
        extends LogWriter
{
            ...
            implements ConcurrentNonCopyWriter<CloseableLogBuffer>
    {
        ...
        @Override
        public CloseableLogBuffer requestSpace(final int length)
                throws IOException
        {
        ...
        private class MultiMappedRegion
        {
            ...
            MultiMappedRegion(long offset, int length, MappedRegion head)
                    throws IOException
            {
                this.offset = offset;
            ...
            private class CloseableMultiMMapLogBuffer
                    extends CloseableLogBuffer
            {
