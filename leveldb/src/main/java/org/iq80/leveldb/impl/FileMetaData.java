...
public class FileMetaData {
  ...
  public FileMetaData(final long number, final long fileSize, final InternalKey smallest,
      final InternalKey largest) {
    this.number = number;
  ...
  public void setAllowedSeeks(final int allowedSeeks) {
